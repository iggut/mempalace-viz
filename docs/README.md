...
| [**MCP_CONNECTION_CAPABILITIES.md**](MCP_CONNECTION_CAPABILITIES.md) | Official MCP **tool coverage matrix** vs this HTTP bridge; `graph_stats` vs `find_tunnels`; **no** arbitrary persisted palace graph links |
