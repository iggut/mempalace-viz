...
Concise references for the MemPalace 3D visualization. The **shipped product** behavior is described in the root **`README.md`**; these files go deeper on contracts and semantics.
