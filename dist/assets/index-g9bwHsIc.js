...
void main() {
    ...
    </details>`:""}`}function w0(){return!!(C.pinned&&C.selected)}function Nr(){return{view:"graph",selected:C.selected,pinned:C.pinned,currentWing:C.currentWing,currentRoom:C.currentRoom}}function Eo(){var f,d,m,_;if(C.view!=="graph"||!C.selected||C.selected.type==="center")return"";const n=C.selected.id,e=((d=(f=Y==null?void 0:Y.getGraphNeighbors)==null?void 0:f.call(Y,n))==null?void 0:d.length)??0,t=e>0,i=Ce.result,r=(i==null?void 0:i.ok)&&((m=i.pathSceneIds)==null?void 0:m.length),s=r?i.pathSceneIds.length:0,a=r?`Hop ${dr(Ce.stepIndex,s)+1} / ${s}`:"",o=C.view==="graph"&&Ce.startSceneId,c=o?`<div class="graph-route-mode" role="group" aria-label="Route mode">${ru.map(g=>{const p=Fn===g,u=Ur[g];return`<button type="button" class="route-mode-chip ${p?"is-on":""}" data-route-mode="${Ae(g)}" title="${Ae(u.hint)}">${Ae(u.shortLabel)}</button>`}).join("")}</div>`:"",l=r&&i.comparisonNote?`<div class="graph-route-strip__compare">${Ae(i.comparisonNote)}</div>`:"";return`${r?`<div class="graph-route-strip" role="group" aria-label="Route along highlighted path">
    ${c}
    ${l}
    <span class="graph-route-strip__meta">${Ae(a)} · ${i.hops} edge${i.hops===1?"":"s"} · ${Ae(((_=Ur[Fn])==null?void 0:_.shortLabel)||Fn)}</span>
  ...
  </div>`}function T0(){var n;C.view!=="graph"||!((n=C.selected)!=null&&n.id)||Y==null||Y.centerOnNodeId(C.selected.id)}function Ps(n){var a;if(C.view!=="graph"||!((a=C.selected)!=null&&a.id)||!(Y!=null&&Y.getGraphNeighbors))return;const e=C.selected.id,t=Y.getGraphNeighbors(e),i=K_(t,e,n);if(!i){fn(P_());return}if(i===e)return;const r=ar(i);if(!r||!Z||!vi(Z.roomsData,r.wing,r.room))return;Dr(Qn,Nr());const s=(Z.roomsData[r.wing]||[]).find(o=>o.name===r.room);C.currentWing=r.wing,C.currentRoom=r.room,C.selected={id:i,type:"room",name:r.room,wing:r.wing,wingId:r.wing,roomId:(s==null?void 0:s.roomId)||It(r.wing,r.room),drawers:s==null?void 0:s.drawers},C.pinned=!0,Mt(),Y==null||Y.centerOnNodeId(i),St(),_t()}function pu(){var e;const n=Y_(Qn);if(!n||n.view!=="graph"||!((e=n.selected)!=null&&e.id)){fn("No prior focus in history.");return}C.selected=n.selected,C.pinned=n.pinned,C.currentWing=n.currentWing,C.currentRoom=n.currentRoom,Mt(),Y==null||Y.centerOnNodeId(n.selected.id),St(),_t()}function Ho(){Ce={startSceneId:null,targetSceneId:null,result:null,stepIndex:0},Mt(),St(),_t()}function A0(n){var t,i;const e=bi(n);if(e!==Fn){if(Fn=e,S0(e),Ce.startSceneId&&Ce.targetSceneId){const r=Ce.stepIndex;kr();const s=Ce.result;s!=null&&s.ok&&((t=s.pathSceneIds)!=null&&t.length)?(Ce.stepIndex=dr(r,s.pathSceneIds.length),zs(),Y==null||Y.centerOnNodeId((i=C.selected)==null?void 0:i.id)):Ce.stepIndex=0,s&&!s.ok&&fn(s.message||"No route for this mode.")}Mt(),St()}}function R0(){const n=Ce.result;if(n&&n.ok&&Array.isArray(n.pathSceneIds)&&n.pathSceneIds.length){const e=n.pathSceneIds.length,t=dr(Ce.stepIndex,e),i=(n.bridges||[]).map(r=>n0(r)).filter(Boolean);return{active:!0,pathSceneIds:n.pathSceneIds,stepIndex:t,segmentTypes:n.segmentTypes||[],bridgeSceneIds:i}}return{active:!1,pathSceneIds:[],stepIndex:0,segmentTypes:[],bridgeSceneIds:[]}}function kr(){var s;if(!Z||C.view!=="graph"){Ce.result=null;return}const n=Ce.startSceneId,e=Ce.targetSceneId;if(!n||!e||!n.startsWith("room:")||!e.startsWith("room:")){Ce.result=null;return}const t=Jc(n),i=Jc(e);if(!t||!i){Ce.result={ok:!1,reason:"bad_scene",message:"Could not resolve route endpoints."};return}const r=hr(gi(Z.graph));Ce.result=a0({graphEdges:gi(Z.graph),roomsData:Z.roomsData||{},enabledRelTypes:Qt,availableRelTypes:r,startRoomId:t,endRoomId:i,routeMode:Fn}),Ce.result.ok&&((s=Ce.result.pathSceneIds)!=null&&s.length)?Ce.stepIndex=dr(Ce.stepIndex,Ce.result.pathSceneIds.length):Ce.stepIndex=0}function zs(){var s;const n=Ce.result;if(!(n!=null&&n.ok)||!((s=n.pathSceneIds)!=null&&s.length))return;const e=dr(Ce.stepIndex,n.pathSceneIds.length),t=n.pathSceneIds[e],i=ar(t);if(!i||!Z)return;const r=(Z.roomsData[i.wing]||[]).find(a=>a.name===i.room);C.currentWing=i.wing,C.currentRoom=i.room,C.selected={id:t,type:"room",name:i.room,wing:i.wing,wingId:i.wing,roomId:(r==null?void 0:r.roomId)||It(i.wing,i.room),drawers:r==null?void 0:r.drawers},C.pinned=!0}function C0(){var n,e;if(C.view!=="graph"||((n=C.selected)==null?void 0:n.type)!=="room"||!((e=C.selected)!=null&&e.id)){fn("Select a room in Graph view first.");return}Ce.startSceneId=C.selected.id,Ce.targetSceneId?kr():Ce.result=null,Mt(),St(),_t(),fn("Route start set — pick a target room or use search “Route”.")}function mu(n){var t,i;if(C.view!=="graph"&&$n("graph"),!n||!n.startsWith("room:")){fn("Route target must be a room.");return}if(!Ce.startSceneId){fn("Set a route start first (inspector: “Set as route start”).");return}Ce.targetSceneId=n,kr();const e=Ce.result;e&&!e.ok?fn(e.message||"No route found."):e!=null&&e.ok&&(Ce.stepIndex=0,zs(),Y==null||Y.centerOnNodeId((t=C.selected)==null?void 0:t.id),fn(`Route · ${e.hops} hop${e.hops===1?"":"s"} · ${((i=Ur[Fn])==null?void 0:i.shortLabel)||Fn}`)),Mt(),St(),_t()}function Is(n){var i,r;const e=Ce.result;if(!(e!=null&&e.ok)||!((i=e.pathSceneIds)!=null&&i.length))return;const t=e.pathSceneIds.length;Ce.stepIndex=c0(Ce.stepIndex,n,t),zs(),Mt(),Y==null||Y.centerOnNodeId((r=C.selected)==null?void 0:r.id),St(),_t()}function il(n){var i,r;const e=Ce.result;if(!(e!=null&&e.ok)||!((i=e.pathSceneIds)!=null&&i.length))return;const t=e.pathSceneIds.length;Ce.stepIndex=n==="end"?t-1:0,zs(),Mt(),Y==null||Y.centerOnNodeId((r=C.selected)==null?void 0:r.id),St(),_t()}function Ae(n){return String(n??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function L0(n){var l;if(!(n!=null&&n.ok))return"";const e=sr(n.typeCounts)||"—",t=n.bridges||[],i=t.length>0?`Bridge rooms (cross-wing connectors): ${t.map(h=>h.split("/").pop()).join(", ")}.`:"No interior cross-wing bridge hops — path is short or stays within-wing.",r=((l=Ur[n.routeMode])==null?void 0:l.label)||n.routeMode,s=n.routeMode!=="shortest"&&n.totalCost!=null?` · weighted cost ${n.totalCost}`:"",a=n.mixSummary?`${n.mixSummary} `:"",o=n.comparisonNote?` ${n.comparisonNote}`:"";return`Uses only explicit edges from MemPalace MCP (what is visible in the scene). Mode: ${r}${s}. ${n.hops} hop(s) on visible edges. ${a}Types: ${e}. ${i}${o}`}function Ze(n){return n==null||Number.isNaN(Number(n))?"—":Number(n).toLocaleString()}function P0(n){if(!n||typeof n!="object")return null;const e=[];for(const[t,i]of Object.entries(n))t!=="error"&&(typeof i=="number"?e.push(`${t}: ${Ze(i)}`):typeof i=="string"&&e.push(`${t}: ${i}`));return e.length?e.slice(0,8).join(" · "):null}function oa(){var M,w,O,D;const n=Z==null?void 0:Z.status,e=(Z==null?void 0:Z.wingsData)||{},t=(Z==null?void 0:Z.roomsData)||{},i=Z==null?void 0:Z.graphStats,r=Z==null?void 0:Z.graph,s=(M=r==null?void 0:r.edgesResolved)!=null&&M.length?r.edgesResolved:(i==null?void 0:i.edgesResolved)||[],a=pl(r),o=gi(r),c=Z==null?void 0:Z.kgStats,l=(Z==null?void 0:Z.overviewStats)??((w=Z==null?void 0:Z.overviewBundle)==null?void 0:w.stats),h=(Z==null?void 0:Z.graphMeta)??((O=Z==null?void 0:Z.graph)==null?void 0:O.graphMeta)??(i==null?void 0:i.graphMeta)??((D=Z==null?void 0:Z.overviewBundle)==null?void 0:D.graphMeta),f=typeof(n==null?void 0:n.total_drawers)=="number"?n.total_drawers:typeof(l==null?void 0:l.totalDrawers)=="number"?l.totalDrawers:$_(e),d=typeof(l==null?void 0:l.totalWings)=="number"?l.totalWings:Object.keys(e).length,m=typeof(l==null?void 0:l.totalRooms)=="number"?l.totalRooms:ta(t);let _=0;const g=(r==null?void 0:r.summary)??(i==null?void 0:i.summary);(g==null?void 0:g.resolvedEdgeCount)!=null?_=g.resolvedEdgeCount:i!=null&&i.tunnels&&typeof i.tunnels=="object"&&(_=Object.keys(i.tunnels).length);const p=typeof(g==null?void 0:g.resolvedEdgeCount)=="number"?g.resolvedEdgeCount:s.length,u=qc(t,{edgesResolved:s,graphEdges:gi(r),graphSummary:g??null,overviewStats:l??null}),v=qc(t,{edgesResolved:a,graphEdges:o,graphSummary:null,overviewStats:null}),x=C.view==="graph"?v:u,E=P0(c),P=!!(c&&typeof c=="object"&&!c.error),T=hr(o),A=a_(a,Qt),K=zr(Qt,T)!==null;return{status:n,wingsData:e,roomsData:t,graphEdges:o,graphStats:i,edgesResolved:a,edgesExplicit:s,kgStats:c,totalDrawers:f,wingCount:d,roomCount:m,tunnelNodeCount:_,graphEdgeCount:p,ga:x,gaPalace:u,gaGraph:v,kgAvailable:P,kgSummary:E,focusWing:C.currentWing,overviewStats:l,graphMeta:h,summary:g,availableRelationshipTypes:T,visibleGraphSummary:A,graphFilterNarrowed:K}}function I0(){try{const n=localStorage.getItem(eu);return n?JSON.parse(n):null}catch{return null}}function gu(n){try{localStorage.setItem(eu,JSON.stringify({enabledTypes:[...n||[]]}))}catch{}}function D0(){const n=gi(Z==null?void 0:Z.graph),e=hr(n),t=I0(),i=t==null?void 0:c_(t);Qt=s_(i,e),gu(Qt),Y==null||Y.setRelationshipFilters(zr(Qt,e))}function U0(n){const e=hr(gi(Z==null?void 0:Z.graph));if(!(!n||!e.includes(n))){if(Qt.has(n)?Qt.delete(n):Qt.add(n),gu(Qt),Y==null||Y.setRelationshipFilters(zr(Qt,e)),Ce.startSceneId&&Ce.targetSceneId){kr();const t=Ce.result;t&&!t.ok&&fn(t.message||"No route on current visible edges — adjust filters or clear route.")}St(),bn(),wi(),Mt()}}function wi(){const n=re("graph-view-extras");if(!n)return;const e=C.view==="graph"&&!!Z&&!Z.error;if(n.hidden=!e,!e)return;const t=oa(),i=t.availableRelationshipTypes||[],r=re("graph-rel-chips");r&&(i.length?r.innerHTML=i.map(o=>{const c=Fo(o),l=Qt.has(o),h=o==="tunnel"?"#5b8cff":"#a78bfa";return`<button type="button" class="rel-chip ${l?"is-on":""}" data-rel-type="${Ae(o)}" title="${Ae(c.description)}">
          <span class="rel-chip__swatch" style="background:${h}"></span>
          <span>${Ae(c.shortLabel)}</span>
        </button>`}).join(""):r.innerHTML='<span class="inspect-muted">No typed edges in this graph.</span>');const s=re("graph-status-pill");if(s){const o=t.graphFilterNarrowed,c=t.visibleGraphSummary,l=l_(t.graphMeta,t.summary),h=`${Ze(t.graphEdgeCount)} MCP tunnel edge(s)`,f=o?`Visible: ${Ze(c.visibleEdgeCount)} (filtered) · base ${h}`:`${h}`;s.innerHTML=`<span class="graph-status-pill__primary">${Ae(f)}</span>${l?`<span class="graph-status-pill__hint">${Ae(l.length>240?`${l.slice(0,240)}…`:l)}</span>`:""}`}const a=re("graph-legend-compact");a&&(a.innerHTML=i.length?i.map(o=>{const c=Fo(o);return`<div class="graph-legend-compact__row"><span class="legend-swatch" style="background:${o==="tunnel"?"#5b8cff":"#a78bfa"}"></span><span><strong>${Ae(c.shortLabel)}</strong> — ${Ae(c.description)}</span></div>`}).join(""):"")}function en(n,e,t){const i=e&&String(e).trim()?e:`<p class="inspect-empty">${Ae("No data.")}</p>`;return`
    <section class="inspect-section">
      <h3 class="inspect-section__title">${Ae(n)}</h3>
      <div class="inspect-section__body">${i}</div>
    </section>`}function _u(n){return n==null||Number.isNaN(Number(n))?"":`<div class="inspect-bar" aria-hidden="true"><div class="inspect-bar__fill" style="width:${Math.min(100,Math.max(0,Number(n)))}%"></div></div>`}function Un(n,e,t){return`<button type="button" class="inspect-row inspect-row--action"${Object.entries(t||{}).map(([s,a])=>` data-${s}="${Ae(String(a))}"`).join("")}>
    <span class="inspect-row__main">${Ae(n)}</span>
    <span class="inspect-row__meta">${Ae(e)}</span>
  </button>`}function N0(n){var f,d,m,_;const e=q_(n,C.view),t=e.ga.byRelationshipType&&Object.keys(e.ga.byRelationshipType).length?Object.entries(e.ga.byRelationshipType).map(([g,p])=>`${g}: ${Ze(p)}`).join(" · "):"",i=(d=(f=n.graphMeta)==null?void 0:f.truncatedSources)!=null&&d.length?n.graphMeta.truncatedSources.map(g=>{const p=g.totalMatching!=null&&g.totalMatching!==""?Ze(g.totalMatching):"unknown",u=g.inferred?" (heuristic)":"";return`${g.source} limit ${Ze(g.limit)} · ${p} rows reported${u}`}).join("; "):"",r=(((m=n.graphMeta)==null?void 0:m.completenessNotes)||[]).filter(Boolean).join(" "),s=e.kgAvailable?e.kgSummary||"—":"Knowledge graph statistics are unavailable from the current API.",a=e.largestWingsByDrawers.map(g=>Un(g.wing,`${Ze(g.drawers)} drawers · #${g.rank}`,{"inspect-action":"go-wing",wing:g.wing})).join(""),o=e.mostConnectedRooms.length?e.mostConnectedRooms.map(g=>Un(`${g.room}`,`${g.wing} · degree ${g.degree}`,{"inspect-action":"select-room",wing:g.wing,room:g.room})).join(""):"",c=e.mostCrossLinkedWings.length?e.mostCrossLinkedWings.map(g=>Un(g.wing,`${Ze(g.crossEdges)} cross-wing edges`,{"inspect-action":"go-wing",wing:g.wing})).join(""):"",l=[`Palace scale: ${Ze(e.totalDrawers)} drawers across ${Ze(e.wingCount)} wings and ${Ze(e.roomCount)} rooms.`,e.tunnelNodeCount?`Graph summary: ${Ze(e.graphEdgeCount)} resolved undirected edges (all relationship types).`:"No graph edges in graph-stats.",e.graphBlurb].filter(Boolean).join(" "),h=C.view==="graph"&&((_=n.ga)!=null&&_.hasResolvableEdges)&&n.graphFilterNarrowed?`<div class="inspect-card inspect-card--hint" role="status"><strong>Graph filters active</strong><p class="inspect-muted inspect-muted--tight">Visible: ${Ze(n.visibleGraphSummary.visibleEdgeCount)} edges (${sr(n.visibleGraphSummary.visibleByType)||"—"}). Inspector “visible” rows match the scene. Footer and resolved totals above remain global.</p></div>`:"";return`
    <div class="inspect-stack">
      <div class="inspect-card inspect-card--hero">
        <span class="badge">Overview</span>
        <p class="inspect-lead">${Ae(e.viewHint)}</p>
        <p class="inspect-muted">${Ae(l)}</p>
      </div>
      ${b0(n)}
      ${h}
      ${en("Palace summary",`
        ...
        ${r?`<p class="inspect-muted inspect-muted--tight">${Ae(r)}</p>`:""}
        <p class="inspect-muted inspect-muted--tight">${Ae(s)}</p>
        `)}
    ...
    <div class="inspect-stack">
      ...
      <div class="inspect-card inspect-card--hero">
        ...
        <div class="inspect-title">${Ae(e)}</div>
        <p class="inspect-lead">${Ae(K||"Wing footprint in the palace.")}</p>
      ...
      ${en("Connections",a.hasResolvableEdges?`<div class="meta-block">
        ...
        ${L?`<p class="inspect-muted inspect-muted--tight">${Ae(L)}</p>`:""}
      ...
      ${en("Health / graph insight",`<p class="inspect-muted">${Ae(((de=a.topCrossLinkedWings[0])==null?void 0:de.wing)===e?"This wing is among the most cross-linked in the tunnel graph.":M.crossWingTouches>0?"Participates in cross-wing tunnels; see Connections for peers.":h>0?"No cross-wing tunnel edges touch this wing in the current graph.":"Add taxonomy rooms to compare structure.")}</p>`)}
          ...
          <div class="btn-row" style="margin-top:8px;flex-wrap:wrap;gap:6px">
            ...
            <button type="button" class="btn btn--ghost btn--sm" data-route-action="route-here" data-wing="${Ae(e)}" data-room="${Ae(t)}" ${de?"":"disabled"} title="Compute route along visible edges (current mode)">Route to here</button>
          ...
          ${(te=Ce.result)!=null&&te.ok?`<p class="inspect-muted inspect-muted--tight" role="status">${Ae(L0(Ce.result))}</p>`:""}
          ${Ce.result&&!Ce.result.ok?`<div class="route-fail-guidance" role="status">
            <p class="inspect-muted inspect-muted--tight">${Ae(Ce.result.message||"")}</p>
            ${L_(String(Ce.result.reason||""),{graphFilterNarrowed:Ce.result.graphFilterNarrowed??n.graphFilterNarrowed}).map(se=>`<p class="inspect-muted inspect-muted--tight inspect-guidance-line">${Ae(se)}</p>`).join("")}
          </div>`:""}`):"";return`
    <div class="inspect-stack">
      ${ee}
      ${k}
      <div class="inspect-card inspect-card--hero">
        ...
        <div class="inspect-title">${Ae(t)}</div>
        <p class="inspect-lead">${Ae(v||"Room in the palace taxonomy.")}</p>
      ...
      ${en("Connections",P&&E?`
        ...
        ${w?`<p class="inspect-muted inspect-muted--tight">${Ae(w)}</p>`:""}
        <p class="inspect-muted inspect-muted--tight">${Ae(X)}</p>
        ${z?`<p class="inspect-micro">Related rooms (global graph)</p><div class="inspect-rows">${z}</div>`:`<p class="inspect-empty">No tunnel neighbors found for this room.</p>${P?`<p class="inspect-muted inspect-muted--tight">${Ae(O_())}</p>`:""}`}
      ...
      ${en("Insight",`<p class="insight-chip">${Ae(O.label)}</p><p class="inspect-muted inspect-muted--tight">${Ae(O.detail)}</p>`)}
    </div>`}function B0(n){const e=n.target.closest("[data-route-mode]");if(e){const c=e.getAttribute("data-route-mode");c&&A0(c);return}const t=n.target.closest("[data-route-action]");if(t){const c=t.getAttribute("data-route-action");if(c==="set-start")C0();else if(c==="route-here"){const l=t.getAttribute("data-wing"),h=t.getAttribute("data-room");l&&h&&mu(`room:${l}:${h}`)}else c==="clear-route"&&Ho();return}const i=n.target.closest("[data-graph-action]");if(i){const c=i.getAttribute("data-graph-action");c==="frame-nbr"?T0():c==="next"?Ps(1):c==="prev"?Ps(-1):c==="back"?pu():c==="route-start"?il("start"):c==="route-end"?il("end"):c==="route-prev"?Is(-1):c==="route-next"?Is(1):c==="route-clear"&&Ho();return}const r=n.target.closest("[data-inspect-action]");if(!r)return;const s=r.getAttribute("data-inspect-action"),a=r.getAttribute("data-wing"),o=r.getAttribute("data-room");if(s==="go-wing"&&a){xu(a);return}s==="select-room"&&a&&o&&z0(a,o)}function z0(n,e){var s,a;if(Hr(),!Z||!_i(Z.wingsData,n)||!vi(Z.roomsData,n,e))return;const t=Z.roomsData[n],i=Array.isArray(t)?t.find(o=>o.name===e):null,r=`room:${n}:${e}`;if(C.view==="graph"){(s=C.selected)!=null&&s.id&&C.selected.id!==r&&Dr(Qn,Nr()),C.currentWing=n,C.currentRoom=e,C.selected={id:r,type:"room",name:e,wing:n,wingId:n,roomId:(i==null?void 0:i.roomId)||It(n,e),drawers:i==null?void 0:i.drawers},C.pinned=!0,Mt(),Y==null||Y.centerOnNodeId(r),bn(),St(),_t();return}C.currentWing=n,C.currentRoom=e,C.selected={id:r,type:"room",name:e,wing:n,wingId:n,roomId:(i==null?void 0:i.roomId)||It(n,e),drawers:i==null?void 0:i.drawers},C.pinned=!1,C.view="rooms",Y==null||Y.setView("rooms",n),Mt(),Y==null||Y.centerOnNodeId(r),fr(),re("view-helper-text").textContent=((a=ti.find(o=>o.id==="rooms"))==null?void 0:a.hint)||"",wi(),bn(),St(),_t()}function k0(n){if(!n||n.type==="center"||!n.id)return null;const e=n.wingId??n.wing,t=n.roomId??(n.type==="room"&&e&&n.name!=null?It(e,n.name):null);return{id:n.id,type:n.type,name:n.name,wing:e,wingId:e,roomId:t,drawers:n.drawers}}function H0(){try{const n=localStorage.getItem(sa);return n?JSON.parse(n):null}catch{return null}}function _t(){clearTimeout(el),el=setTimeout(()=>{var n,e,t;try{const i={view:C.view,currentWing:C.currentWing,currentRoom:C.currentRoom,selected:C.selected,pinned:C.pinned,searchQuery:C.searchQuery,labels:((n=re("toggle-labels"))==null?void 0:n.checked)??!0,rotate:((e=re("toggle-rotate"))==null?void 0:e.checked)??!0,motion:Number(((t=re("motion-range"))==null?void 0:t.value)??1)};localStorage.setItem(sa,JSON.stringify(i))}catch{}},200)}function rl(){Z&&g0(C,Z)}function G0(n){n&&(n.labels!==void 0&&re("toggle-labels")&&(re("toggle-labels").checked=!!n.labels),n.rotate!==void 0&&re("toggle-rotate")&&(re("toggle-rotate").checked=!!n.rotate),n.motion!==void 0&&re("motion-range")&&(re("motion-range").value=String(n.motion)),n.searchQuery!==void 0&&re("search-wings")&&(re("search-wings").value=n.searchQuery))}function W0(n){if(n==null)return;const e=m0(n);C.view=e.view,C.currentWing=e.currentWing,C.currentRoom=e.currentRoom,C.selected=e.selected,C.pinned=e.pinned,C.searchQuery=e.searchQuery}function Mt(){var n;Y==null||Y.updatePresentation({searchQuery:C.searchQuery,selectedId:((n=C.selected)==null?void 0:n.id)??null,pinActive:C.pinned,route:R0()})}function vs(n,e){const t=re("conn-status");t&&(t.dataset.state=n,t.textContent=e)}function ys(n){var e;(e=re("loading-overlay"))==null||e.classList.toggle("is-hidden",!n)}function V0(n,e){var i;ys(!0);const t=re("loading-overlay");t&&(t.innerHTML=`
    <div class="err-box">
